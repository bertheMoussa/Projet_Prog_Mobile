...
class _HomeWifiPtoP2State extends State<HomeWifiPtoP2> with WidgetsBindingObserver {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                snack((await _flutterP2PConnectionPlugin.checkLocationEnabled()) ? "enabled" : "diabled");
              },
              child: const Text("check location enabled"),
            ),
            ElevatedButton(
              onPressed: () async {
                snack((await _flutterP2PConnectionPlugin.checkWifiEnabled()) ? "enabled" : "diabled");
              },
